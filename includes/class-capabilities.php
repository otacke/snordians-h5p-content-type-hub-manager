...
class Capabilities {
	...
	public static function add_capabilities() {
		...
		foreach ( $all_roles as $role_name => $role_info ) {
			...
			self::map_capability( $role, $role_info, 'manage_h5p_libraries', 'manage_h5p_content_type_hub' );
		}
	}
	...
	public static function remove_capabilities() {
		...
		foreach ( $all_roles as $role_name => $role_info ) {
			...
			if ( isset( $role_info['capabilities']['manage_h5p_content_type_hub'] ) ) {
				$role->remove_cap( 'manage_h5p_content_type_hub' );
			}
		}
	}
